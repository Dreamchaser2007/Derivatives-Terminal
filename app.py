...
def index():
    ...
    return render_template("index.html",
        ...
        fx_chain_form=fx_chain_form, fx_chain_calls=fx_chain_calls, fx_chain_puts=fx_chain_puts,
        eq_chain_form=eq_chain_form, eq_chain_calls=eq_chain_calls, eq_chain_puts=eq_chain_puts,
